...
const Job = () => {
  ...
  const { fn: fnupdateHiringStatus, loading: loadingupdateStatus } = useFetch(
    updateHiringStatus,
    { job_id: id }
  );
  ...
  const handleStatusChange = (value) => {
    ...
    fnupdateHiringStatus(isOpen).then(() => {
      fnJob();
    });
  };
  ...
  return (
    <div className="flex flex-col gap-8 mt-5">
      ...
      <h2 className="text-3xl sm:text-3xl font-bold">About the Job:</h2>
